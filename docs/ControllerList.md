...
| <img src="SetupGuide/Images/ESP32-S3/ControllerSetup-ESP32-S3.jpg" width="200"> | ESP32-S3 {.nowrap} | HID: Keyboard<br>NS1: Wired Controller<br>NS2: Wired Controller<br>NS1: Wired Pro Controller (coming soon)<br>NS1: Wired Left Joycon (coming soon)<br>NS1: Wired Right Joycon (coming soon) {.nowrap} | 3 | [Windows](SetupGuide/Controllers/Controller-ESP32-S3.md)<br>[Video Tutorial](https://youtu.be/ezBuwk48z8w) {.nowrap} |
...
| <img src="SetupGuide/Images/PicoW/ControllerSetup-PicoW-UART.jpg" width="200"> | Raspberry Pi Pico W<br>Raspberry Pi Pico 2 W<br>(UART Mode) {.nowrap} | HID: Keyboard<br>NS1: Wired Controller<br>NS2: Wired Controller<br>NS1: Wired Pro Controller (coming soon)<br>NS1: Wired Left Joycon (coming soon)<br>NS1: Wired Right Joycon (coming soon)<br>NS1: Wireless Pro Controller<br>NS1: Wireless Left Joycon<br>NS1: Wireless Right Joycon {.nowrap} | 5 | [Guide](SetupGuide/Controllers/Controller-PicoW-UART.md) {.nowrap} |
| <img src="SetupGuide/Images/PicoW/ControllerSetup-PicoW-Advanced.jpg" width="200"> | Raspberry Pi Pico W<br>Raspberry Pi Pico 2 W<br>(Advanced UART Mode) {.nowrap} | HID: Keyboard<br>NS1: Wired Controller<br>NS2: Wired Controller<br>NS1: Wired Pro Controller (coming soon)<br>NS1: Wired Left Joycon (coming soon)<br>NS1: Wired Right Joycon (coming soon)<br>NS1: Wireless Pro Controller<br>NS1: Wireless Left Joycon<br>NS1: Wireless Right Joycon {.nowrap} | 10 | [Guide](SetupGuide/Controllers/Controller-PicoW-Advanced.md) {.nowrap} |
...
| --- | --- | --- | --- | --- |
| Raspberry Pi Pico W<br>(USB Mode) {.nowrap} | NS1: Wireless Pro Controller<br>NS1: Wireless Left Joycon<br>NS1: Wireless Right Joycon {.nowrap} | Single: $8<br>Volume: $7 {.nowrap} | 1 | Upgradable to UART mode. {.nowrap} |
...
| Raspberry Pi Pico W<br>(UART Mode) {.nowrap} | HID: Keyboard<br>NS1: Wired Controller<br>NS2: Wired Controller<br>NS1: Wireless Pro Controller<br>NS1: Wireless Left Joycon<br>NS1: Wireless Right Joycon {.nowrap} | Single: $19<br>Volume: $10 {.nowrap} | 5 | [Vulnerable to power glitching.](PowerGlitching.md)<br>Exposed pins can be annoying. {.nowrap} |
| Raspberry Pi Pico W<br>(Advanced UART Mode) {.nowrap} | HID: Keyboard<br>NS1: Wired Controller<br>NS2: Wired Controller<br>NS1: Wireless Pro Controller<br>NS1: Wireless Left Joycon<br>NS1: Wireless Right Joycon {.nowrap} | Single: $30+<br>Volume: $12 {.nowrap} | 10 | Best final product.<br>Hardest to build. {.nowrap} |
...
| <img src="Images/Controllers/Switch1-ProController.jpg" width="300"> | **Switch 1: Wired/Wiress Pro Controller**<br><br>This is the official pro controller from Nintendo. In addition to all the features of the 3rd party wired controllers above, it also supports gyro, rumble, NFC, console wake up, and custom icon colors. (Though we currently only support rumble and console colors.)<br><br>This controller exists in two variants, wired and wireless. Wireless is supported by the ESP32 and the Pico W. Wired is currently only supported sys-botbase, but will soon be coming to the ESP32-S3 and the Pico W (UART).<br><br>This controller uses Nintendo's proprietary 48-byte HID report 0x30. |
| <img src="Images/Controllers/Switch1-Joycons.jpg" width="300"> | **Switch 1: Wired/Wireless Joycons**<br><br>These are the official joycons from Nintendo and supports the same set of features as the Pro Controller (minus fewer buttons/joysticks). Joycons are important to this project because they are required for some games such as Pokémon Let's Go Pikachu and Eevee (LGPE).<br><br>While wired joycons do not (officially) exist, the protocol for it does. Thus joycons can also be either wired or wireless. Wireless is supported by the ESP32 and Pico W controllers. Wired is not yet supported, but will soon be coming to the ESP32-S3 and the Pico W (UART).<br><br>These use Nintendo's proprietary 48-byte HID report 0x30. |
...
| **Device** | **Controller** |
| --- | --- |
| ESP32-S3<br>Pico 1/2 W (UART mode) {.nowrap} | HID: Keyboard<br>NS1: Wired Controller<br>NS2: Wired Controller<br>NS1: Wired Pro Controller (coming soon)<br>NS1: Wired Left Joycon (coming soon)<br>NS1: Wired Right Joycon (coming soon) {.nowrap} |
