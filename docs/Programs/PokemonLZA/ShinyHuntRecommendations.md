...
| Weedle<br>Kakuna<br>Spinarak<br>Gastly| **Wild Zone 4**<br> **Movement:** Approach Gate But Don't Enter.<br> Weedle and Kakuna spawn in the tree to the North.<br>Spinarak and Gastly will spawn just inside the gate. | [<img src="images/ShinyHuntLocations/WildZone4-WeedleKakuna-small.png" width="300">](images/ShinyHuntLocations/WildZone4-WeedleKakuna.png) |
